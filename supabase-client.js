...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpYXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRkdm9ucWdvdWZ0Z3B4dm1udmV1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODc4NzAyODcsImV4cCI6MjEwMzQ0NjI4N30._tumoC5lYq0CWhSu-SiWaOxOYFNx0AGGFSFI8hU7EBk';

const configured = !SUPABASE_URL.includes('TU-PROJECT-REF') && !SUPABASE_ANON_KEY.includes('TU_ANON_KEY');
